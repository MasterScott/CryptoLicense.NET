...
{
    /// <summary>
    /// This grabs a good HWID from the computer & then is hashed
    /// </summary>
    public class UIDHelper
    {
        public string Generate()
        {
            ...
            return GetHash(string.Join(string.Empty, wmiData));
        }
        ...
        private string GetProperties(string[] wmiData)
        {
            ...
            using (var moSearcher = new ManagementObjectSearcher("root\\CIMV2", GenerateQuery(wmiData)))
